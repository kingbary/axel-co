...
export default function WhatWeDo() {
    return (
        <section className="bg-dark text-sleekWhite py-16 px-4 sm:px-10 2xl:px-20 sm:py-20 2xl:py-[120px]">
            <Headings heading='WHAT WE DO' subheading='AxelCo is dedicated to empowering businesses for a thriving future through technology-driven solutions, consulting, and digital transformation services for leading African enterprises, with a focus on creating social impact.' />
